...
from automatic_mask_placement.cad2roi.morph_ops import dilate, close
from automatic_mask_placement.cad2roi.mask_utils import merge_class_masks, mask_area, mask_bbox
from imaginaire.utils import log


def get_missing_candidates(components: dict, img_shape: tuple,
