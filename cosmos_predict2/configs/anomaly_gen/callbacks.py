...
from cosmos_predict2.callbacks.detailed_iter_speed import DetailedIterSpeed
...
BASIC_CALLBACKS = dict(
    ...
    iter_speed=L(DetailedIterSpeed)(
        every_n="${trainer.logging_iter}",
    ),
    # DeviceMonitor is expensive. Disable it for now.
    # device_monitor=L(DeviceMonitor)(
    #     every_n="${trainer.logging_iter}",
    # ),
    manual_gc=L(ManualGarbageCollection)(every_n=100),
    loss_log=L(LossLog)(),
