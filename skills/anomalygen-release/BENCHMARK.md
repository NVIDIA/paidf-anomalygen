# Skill Benchmark: anomalygen-release
...
- Dataset digest: `sha256:370ff9aebd0b736929e40074cff2ecbe31d94925986a18fd88664959ad540aaa` (skill-evaluator-dataset-snapshot/1)
- Attempts per task: 1
...
|---|---:|---:|
| Overall | 37% → 89% (+52 points) | 30% → 86% (+56 points) |
| Security | 100% → 100% (±0 points) | 33% → 100% (+67 points) |
| Correctness | 0% → 93% (+93 points) | 40% → 93% (+53 points) |
| Discoverability | 50% → 98% (+48 points) | 35% → 88% (+52 points) |
| Effectiveness | 4% → 62% (+58 points) | 22% → 52% (+31 points) |
| Efficiency | 32% → 92% (+60 points) | 21% → 96% (+75 points) |
