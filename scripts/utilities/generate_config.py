...
Reads the `.agents/skills/anomalygen/assets/ag_config.yaml`
template and substitutes the placeholders in angle brackets with user
values. Anomaly types are read from --defect-spec (one JSONL entry per
type with "defect_type" key).
"""
import argparse
import json
import pathlib
